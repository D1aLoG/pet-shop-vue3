  ...
  <div class="w-full max-w-2xl">
    ...
    <VeeForm v-else @submit="placeOrder" :validation-schema="schema" v-slot="{ isSubmitting }">
      <fieldset class="mb-6">
        ...
        <div class="flex flex-col gap-4">
          <div>
            ...
            <VeeField name="firstName" id="firstName" type="text"
          ...
          <div>
            ...
            <VeeField name="lastName" id="lastName" type="text"
                      class="w-full rounded border p-2 text-black" />
          ...
          <div>
            ...
            <VeeField name="patronymic" id="patronymic" type="text"
                      class="w-full rounded border p-2 text-black" />
            <VeeErrorMessage name="patronymic" class="text-sm text-red-500" />
          </div>
          <div>
            <label for="email" class="block">Email</label>
            <VeeField name="email" id="email" type="email"
                      class="w-full rounded border p-2 text-black" />
      ...
      <fieldset class="mb-6">
        ...
        <VeeField name="comment" as="textarea" rows="4"
                  class="w-full rounded border p-2 text-black" />
      </fieldset>

      <div v-if="submissionError"
           class="mt-4 rounded-lg bg-red-100 p-3 text-center text-sm text-red-700">
        {{ submissionError }}
      </div>
