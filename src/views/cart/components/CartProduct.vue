<template>
  <div class="flex flex-col gap-4 rounded-lg border bg-white p-4 shadow-sm sm:flex-row sm:items-center">
    ...
    <div class="flex items-center justify-between gap-4 sm:justify-end">
      <div class="flex h-10 items-center rounded-lg border select-none">
        <span
          @click.prevent="removeQty(index)"
          class="cursor-pointer px-3 py-1 text-lg text-slate-500 transition hover:bg-slate-100"
          >-</span
        >
      ...
      <button @click.prevent="removeProduct(item)" class="text-slate-400 transition hover:text-red-500">
